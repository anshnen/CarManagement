...
const StyledTextField = styled(TextField)({
  ...
  '& .MuiInputLabel-root': {
    color: '#ccc', // Light label color for dark theme
    fontSize: '14px', // Smaller label size for professionalism
    fontWeight: 500,
  },
  '& .MuiOutlinedInput-notchedOutline': {
    borderColor: '#555', // Subtle border for dark theme
  },
      ...
      >
        <Card
          sx={{
            padding: '32px',
            borderRadius: '16px',
            background: 'rgba(0, 0, 0, 0.7)', // Dark semi-transparent background for card
            boxShadow: '0 8px 32px rgba(0, 0, 0, 0.5)', // Darker shadow
          }}
        >
          <CardContent>
            {/* Logo */}
            ...
            <Typography
              ...
              sx={{
                textAlign: 'center',
                marginTop: '16px',
                color: '#ccc', // Lighter text color for the redirect
              }}
            >
