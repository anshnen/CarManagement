...
const RegisterPage = () => {
  ...
  return (
    <Box className="register-page">
      ...
      <Container component="main" maxWidth="xs" className="register-form-container">
        <Card
          sx={{
            padding: '32px',
            borderRadius: '16px',
            background: 'rgba(255, 255, 255, 0.75)', // Semi-transparent for glassmorphism
        ...
        >
          <CardContent>
            ...
            <Typography component="h1" variant="h5" sx={{ textAlign: 'center', marginBottom: '24px' }}>
              Create Your Account
            </Typography>
